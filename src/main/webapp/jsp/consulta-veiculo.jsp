    ...
    <div class="consulta-container">
        <div class="section-label">
            ...
            <div>
                ...
                <p>Pesquise por placa, RNTRC, categoria ou status</p>
            </div>
        </div>
            ...
            <div class="row filtros-row">
                ...
                <div class="search-wrap">
                    ...
                    <input class="search-input" type="text"
                           placeholder="Buscar por placa, RNTRC, categoria ou status"
                           id="txtFiltro">
                </div>
        ...
        <div class="resultado">
            ...
            <table class="tabela-motoristas" id="tblVeiculos">
                <thead>
                <tr>
                    <th>Placa</th>
                    <th>RNTRC</th>
...
<script src="${pageContext.request.contextPath}/js/consulta-veiculo.js"></script>
</body>
</html>
